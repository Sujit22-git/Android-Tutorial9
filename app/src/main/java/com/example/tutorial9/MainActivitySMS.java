    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(ContextCompat.checkSelfPermission(MainActivitySMS.this, Manifest.permission.SEND_SMS) == PackageManager.PERMISSION_GRANTED){
                    sendMessage();
                }
                else
                {
                    ActivityCompat.requestPermissions(MainActivitySMS.this,new String[]{Manifest.permission.SEND_SMS},100);
                }
            }
        });
    }
